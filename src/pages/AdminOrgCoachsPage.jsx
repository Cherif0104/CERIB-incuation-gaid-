      ...
      <main className="flex-1 p-6 space-y-6">
        ...
        <section className="bg-white rounded-xl shadow-sm border border-cerip-forest/5 overflow-hidden">
          ...
          <p className="px-4 pt-2 text-xs text-cerip-forest/70">
            Créez un compte avec e-mail et mot de passe. Le coach pourra modifier son mot de passe depuis son profil.
          </p>
          <form onSubmit={handleCreateCoach} className="p-4 space-y-4">
        ...
        <section className="bg-white rounded-xl shadow-sm border border-cerip-forest/5 overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="p-6 text-center text-cerip-forest/70 text-sm">Aucun coach. Créez un compte ou liez un compte existant ci-dessus.</div>
          ) : (
