...
function AdminOrgIncubesPage() {
  ...
  const handleCreateIncube = async (e) => {
    e.preventDefault();
    if (!orgId) return;
          ...
          <>
            <section className="bg-white rounded-xl shadow-sm border border-cerip-forest/5 overflow-hidden">
              <h2 className="text-sm font-semibold text-cerip-forest px-4 py-3 border-b border-cerip-forest/10">
                Créer un compte incubé
              </h2>
              <p className="px-4 pt-2 text-xs text-cerip-forest/70">
                Créez un compte avec e-mail et mot de passe. L&apos;incubé pourra modifier son mot de passe depuis son profil.
              </p>
              <form onSubmit={handleCreateIncube} className="p-4 space-y-4">
            ...
            <section className="bg-white rounded-2xl shadow-sm border border-cerip-forest/10 overflow-hidden">
              ...
              {loading ? (
                ...
                <div className="p-8 text-center text-cerip-forest/70 text-sm">
                  Aucun incubé dans cette organisation. Créez un compte ci-dessus ou utilisez les <Link to="/admin-org/codes" className="text-cerip-lime hover:underline">codes d&apos;invitation</Link> pour enrôler.
                </div>
              ) : (
